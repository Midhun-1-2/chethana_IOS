            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 24),
                  _buildSectionTitle("13. User-Generated Content & Zero-Tolerance Policy"),
                  _buildText("The application includes a live chat where listeners can post messages. We have zero tolerance for objectionable content and abusive behaviour of any kind, including but not limited to harassment, hate speech, threats, sexually explicit material, and content that is illegal or infringes on the rights of others."),
                  const SizedBox(height: 8),
                  _buildBulletPoint("Reporting: any message can be reported directly from the chat. Reports are reviewed by our team."),
                  _buildBulletPoint("Blocking: you may block any user from within the chat. Once blocked, you will no longer see messages from that user, and we are notified for review."),
                  _buildBulletPoint("Enforcement: we act on reports within 24 hours. Objectionable content is removed and users responsible for it may be permanently removed from the application."),
                  const SizedBox(height: 24),
